...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "help") || (event.body.toLowerCase() == "hlp")) {
  ...
  if ((event.body.toLowerCase() == "Shuvo") || (event.body.toLowerCase() == "shuvo bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
